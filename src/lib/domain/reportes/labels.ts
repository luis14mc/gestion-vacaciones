...
export const ESTADO_SOLICITUD_LABELS: Record<string, string> = {
  ...
  pendiente_director: 'Pendiente de aprobación de director',
  aprobada_director: 'Aprobada por director / pendiente RRHH',
  rechazada_director: 'Rechazada por director',
  pendiente_secretario_general: 'Pendiente de aprobación Dir. Sec. General',
  aprobada_secretario_general: 'Aprobada Dir. Sec. General / pendiente RRHH',
  rechazada_secretario_general: 'Rechazada por Dir. Sec. General',
